...
str_hdr_7:
  ...
  .byte 0
.align 8
tests_modules_basic_module_moduleVar:
  .quad 0
.align 8
str_hdr_8:
  .byte 11
  ...
  .byte 0
.align 8
tests_modules_basic_module_number:
  .quad 0
.align 8
str_hdr_9:
  .byte 11
...
str_hdr_33:
  ...
  .byte 0
.align 8
tests_modules_string_module_greeting:
  .quad 0
.align 8
str_hdr_34:
  .byte 11
...
str_hdr_46:
  ...
  .byte 0
.align 8
tests_modules_nested_deep_module_deep_value:
  .quad 0
.align 8
str_hdr_47:
  .byte 11
...
str_hdr_67:
  ...
  .byte 0
.align 8
tests_modules_string_module_farewell:
  .quad 0
.align 8
str_hdr_68:
  .byte 11
...
main_pr_next_0_5386:
  ...
  movq -200(%rbp), %rdx
  movq %rax, (%rdx)
  movq tests_modules_basic_module_moduleVar(%rip), %rax
  movq %rax, -2096(%rbp)
  movq -2096(%rbp), %rax
  movq -208(%rbp), %rdx
  movq %rax, (%rdx)
...
main_pr_next_0_492:
  ...
  movq -240(%rbp), %rdx
  movq %rax, (%rdx)
  movq tests_modules_basic_module_number(%rip), %rax
  movq %rax, -2224(%rbp)
  movq -2224(%rbp), %rax
  movq -248(%rbp), %rdx
  movq %rax, (%rdx)
...
main_pr_next_0_6429:
  ...
  movq -760(%rbp), %rdx
  movq %rax, (%rdx)
  movq tests_modules_string_module_greeting(%rip), %rax
  movq %rax, -4040(%rbp)
  movq -4040(%rbp), %rax
  movq -768(%rbp), %rdx
  movq %rax, (%rdx)
...
main_pr_next_0_4067:
  ...
  movq -992(%rbp), %rdx
  movq %rax, (%rdx)
  movq tests_modules_nested_deep_module_deep_value(%rip), %rax
  movq %rax, -4760(%rbp)
  movq -4760(%rbp), %rax
  movq -1000(%rbp), %rdx
  movq %rax, (%rdx)
...
main_pr_next_0_3135:
  ...
  movq -4920(%rbp), %rax
  testq %rax, %rax
  jne main_assert_pass_49
  jmp main_assert_fail_49
main_assert_pass_49:
  movq $0, %rax
  movq -1064(%rbp), %rdx
  movq %rax, (%rdx)
...
main_pr_next_0_3069:
  ...
  movq -5464(%rbp), %rax
  testq %rax, %rax
  jne main_assert_pass_57
  jmp main_assert_fail_57
main_assert_pass_57:
  movq $0, %rax
  movq -1216(%rbp), %rdx
  movq %rax, (%rdx)
...
tests.modules.string_module.say_goodbye_entry:
  ...
  movq -56(%rbp), %rdx
  movq %rax, (%rdx)
  jmp tests.modules.string_module.say_goodbye_block_0
tests.modules.string_module.say_goodbye_block_0:
  movq tests_modules_string_module_farewell(%rip), %rax
  movq %rax, -192(%rbp)
  movq -192(%rbp), %rax
  movq -64(%rbp), %rdx
  movq %rax, (%rdx)
...
tests.modules.string_module.say_hello_entry:
  ...
  movq -56(%rbp), %rdx
  movq %rax, (%rdx)
  jmp tests.modules.string_module.say_hello_block_0
...
tests.modules.nested.deep_module.deep_function_entry:
  ...
  movq -144(%rbp), %rdx
  movq %rax, (%rdx)
  jmp tests.modules.nested.deep_module.deep_function_block_0
tests.modules.nested.deep_module.deep_function_block_0:
  ...
  movq -160(%rbp), %rax
  testq %rax, %rax
  jne tests.modules.nested.deep_module.deep_function_pr_nil_0_4421
  jmp tests.modules.nested.deep_module.deep_function_pr_str_0_4421
tests.modules.nested.deep_module.deep_function_pr_nil_0_4421:
  leaq str_nil(%rip), %rax
  addq $24, %rax
  movq %rax, -168(%rbp)
  movq $1, %rax
  ...
  syscall
  movq %rax, -176(%rbp)
  jmp tests.modules.nested.deep_module.deep_function_pr_next_0_4421
tests.modules.nested.deep_module.deep_function_pr_str_0_4421:
  movq -152(%rbp), %rax
  addq $8, %rax
  movq %rax, -184(%rbp)
  movq -184(%rbp), %rax
  ...
  movq %rax, -208(%rbp)
  jmp tests.modules.nested.deep_module.deep_function_pr_next_0_4421
tests.modules.nested.deep_module.deep_function_pr_next_0_4421:
  leaq nl(%rip), %rax
  addq $24, %rax
  movq %rax, -216(%rbp)
  movq $1, %rax
...
tests.modules.basic_module.greet_entry:
  ...
  movq -136(%rbp), %rdx
  movq %rax, (%rdx)
  jmp tests.modules.basic_module.greet_block_0
tests.modules.basic_module.greet_block_0:
  ...
  movq -152(%rbp), %rax
  testq %rax, %rax
  jne tests.modules.basic_module.greet_pr_nil_0_4919
  jmp tests.modules.basic_module.greet_pr_str_0_4919
tests.modules.basic_module.greet_pr_nil_0_4919:
  leaq str_nil(%rip), %rax
  addq $24, %rax
  movq %rax, -160(%rbp)
  movq $1, %rax
  ...
  syscall
  movq %rax, -168(%rbp)
  jmp tests.modules.basic_module.greet_pr_next_0_4919
tests.modules.basic_module.greet_pr_str_0_4919:
  movq -144(%rbp), %rax
  addq $8, %rax
  movq %rax, -176(%rbp)
  movq -176(%rbp), %rax
  ...
  movq %rax, -200(%rbp)
  jmp tests.modules.basic_module.greet_pr_next_0_4919
tests.modules.basic_module.greet_pr_next_0_4919:
  leaq nl(%rip), %rax
  addq $24, %rax
  movq %rax, -208(%rbp)
  movq $1, %rax
...
tests.modules.basic_module.getModuleVar_entry:
  ...
  movq -128(%rbp), %rdx
  movq %rax, (%rdx)
  jmp tests.modules.basic_module.getModuleVar_block_0
...
tests.modules.string_module.repeat_string_entry:
  ...
  movq -72(%rbp), %rdx
  movq %rax, (%rdx)
  jmp tests.modules.string_module.repeat_string_block_0
...
tests.modules.string_module.repeat_string_block_4:
  ...
  jmp tests.modules.string_module.repeat_string_block_13
tests.modules.string_module.repeat_string_block_6:
  ...
  movq -80(%rbp), %rdx
  movq %rax, (%rdx)
  jmp tests.modules.string_module.repeat_string_block_9
tests.modules.string_module.repeat_string_block_9:
  movq $1, %rax
  movq -120(%rbp), %rdx
  movq %rax, (%rdx)
  movq -120(%rbp), %rax
  ...
  movq %rax, (%rdx)
  jmp tests.modules.string_module.repeat_string_block_4
tests.modules.string_module.repeat_string_block_13:
  movq -80(%rbp), %rax
  movq (%rax), %rax
  movq %rax, -320(%rbp)
  movq -320(%rbp), %rax
...
tests.modules.basic_module.add_entry:
  ...
  movq -72(%rbp), %rdx
  movq %rax, (%rdx)
  jmp tests.modules.basic_module.add_block_0
