...
.align 8
str_const_0:
  .string "=== Function Parameters Test ==="
.align 8
str_const_1:
  .string "Test 1: Function call with parameters"
.align 8
str_const_2:
  .string "Expected: Function should be called with parameters"
.align 8
str_const_3:
  .string "5 + 3 = %s"
.align 8
str_const_4:
  .string "Module function with parameters should work: 5 + 3 = 8"
.align 8
str_const_5:
  .string "Test 2: Function call with return value"
.align 8
str_const_6:
  .string "Expected: Function should return a value"
.align 8
str_const_7:
  .string "4 squared = %s"
.align 8
str_const_8:
  .string "Module function with return value should work: 4 squared = 16"
.align 8
str_const_9:
  .string "Test 3: Nested function calls "
.align 8
str_const_10:
  .string "Expected: Functions should be callable in expressions"
.align 8
str_const_11:
  .string "square(2) + cube(2) = %s"
.align 8
str_const_12:
  .string "Nested function calls should work: square(2) + cube(2) = 4 + 8 = 12"
.align 8
str_const_13:
  .string "=== Function Parameters Test Complete ==="
.align 8
str_const_14:
  .string "NOTE: All tests are currently skipped due to known limitations"
.align 8
nl:
  .string "
"
...
main_block_0:
  ...
  movq $41, rcx
  movq $25, rdx
  call tests.modules.math_module.add
  ...
  call tests.modules.math_module.square
  movq $17, rcx
  call tests.modules.math_module.cube
  movq $r37, rcx
  movq $r39, rdx
  call tests.modules.math_module.add
