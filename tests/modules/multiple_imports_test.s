...
tests.modules.basic_module.greet_block_0:
  ...
  movq -152(%rbp), %rax
  testq %rax, %rax
  jne tests.modules.basic_module.greet_pr_nil_0_1421
  jmp tests.modules.basic_module.greet_pr_str_0_1421
tests.modules.basic_module.greet_pr_nil_0_1421:
  leaq str_nil(%rip), %rax
  addq $24, %rax
  movq %rax, -160(%rbp)
  movq $1, %rax
  ...
  syscall
  movq %rax, -168(%rbp)
  jmp tests.modules.basic_module.greet_pr_next_0_1421
tests.modules.basic_module.greet_pr_str_0_1421:
  movq -144(%rbp), %rax
  addq $8, %rax
  movq %rax, -176(%rbp)
  movq -176(%rbp), %rax
  ...
  movq %rax, -200(%rbp)
  jmp tests.modules.basic_module.greet_pr_next_0_1421
tests.modules.basic_module.greet_pr_next_0_1421:
  leaq nl(%rip), %rax
  addq $24, %rax
  movq %rax, -208(%rbp)
  movq $1, %rax
