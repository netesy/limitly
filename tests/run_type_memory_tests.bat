...
if errorlevel 1 (
 ...
 echo [OK] PASSED: Basic Type Tests
...
if errorlevel 1 (
 ...
 echo [OK] PASSED: Basic Memory Safety Tests
 set /a PASSED_TESTS+=1
)
...
if !FAILED_TESTS! equ 0 (
 echo.
 echo [OK] ALL TESTS PASSED! Type checking and memory safety are working correctly.
 echo.
 echo Key Features Verified:
 echo - [OK] Type inference and compatibility checking
 echo - [OK] Function parameter and return type validation
 echo - [OK] Type alias and union type support
 echo - [OK] Optional and default parameter type checking
 echo - [OK] Memory safety with linear types and ownership
 echo - [OK] Move semantics and reference tracking
 echo - [OK] Scope-based memory management
 echo - [OK] Comprehensive error detection and reporting
) else (
 echo.
