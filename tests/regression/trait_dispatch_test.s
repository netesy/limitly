...
ListIterator.init_entry:
  ...
  movq %rax, (%rdx)
  movq $0, %rax
  jmp ListIterator.init_epilogue
ListIterator.init_epilogue:
  leaq -40(%rbp), %rsp
  popq %r15
  popq %r14
  popq %r13
...
ListIterator.next_entry:
  ...
  movq %rax, (%rdx)
  movq $0, %rax
  jmp ListIterator.next_epilogue
ListIterator.next_epilogue:
  leaq -40(%rbp), %rsp
  popq %r15
  popq %r14
  popq %r13
