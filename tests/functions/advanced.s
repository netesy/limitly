...
greetWithDefault_block_0:
  ...
  movq -200(%rbp), %rax
  testq %rax, %rax
  jne greetWithDefault_pr_nil_0_5736
  jmp greetWithDefault_pr_str_0_5736
greetWithDefault_pr_nil_0_5736:
  leaq str_nil(%rip), %rax
  addq $24, %rax
  movq %rax, -208(%rbp)
  movq $1, %rax
  ...
  syscall
  movq %rax, -216(%rbp)
  jmp greetWithDefault_pr_next_0_5736
greetWithDefault_pr_str_0_5736:
  movq -192(%rbp), %rax
  addq $8, %rax
  movq %rax, -224(%rbp)
  movq -224(%rbp), %rax
  ...
  movq %rax, -248(%rbp)
  jmp greetWithDefault_pr_next_0_5736
greetWithDefault_pr_next_0_5736:
  leaq nl(%rip), %rax
  addq $24, %rax
  movq %rax, -256(%rbp)
  movq $1, %rax
...
greetOptional_block_1:
  ...
  movq -224(%rbp), %rax
  testq %rax, %rax
  jne greetOptional_pr_nil_0_5211
  jmp greetOptional_pr_str_0_5211
...
greetOptional_pr_nil_0_5211:
  ...
  syscall
  movq %rax, -264(%rbp)
  jmp greetOptional_pr_next_0_5211
greetOptional_pr_str_0_5211:
  movq -216(%rbp), %rax
  addq $8, %rax
  movq %rax, -272(%rbp)
  movq -272(%rbp), %rax
...
createUser_block_0:
  ...
  movq -304(%rbp), %rax
  testq %rax, %rax
  jne createUser_pr_nil_0_2567
  jmp createUser_pr_str_0_2567
createUser_pr_nil_0_2567:
  leaq str_nil(%rip), %rax
  addq $24, %rax
  movq %rax, -312(%rbp)
  movq $1, %rax
  ...
  syscall
  movq %rax, -320(%rbp)
  jmp createUser_pr_next_0_2567
createUser_pr_str_0_2567:
  movq -296(%rbp), %rax
  addq $8, %rax
  movq %rax, -328(%rbp)
  movq -328(%rbp), %rax
