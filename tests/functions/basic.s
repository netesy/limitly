...
sayHello_block_0:
  ...
  movq -160(%rbp), %rax
  testq %rax, %rax
  jne sayHello_pr_nil_0_5211
  jmp sayHello_pr_str_0_5211
sayHello_pr_nil_0_5211:
  leaq str_nil(%rip), %rax
  addq $24, %rax
  movq %rax, -168(%rbp)
  movq $1, %rax
  ...
  syscall
  movq %rax, -176(%rbp)
  jmp sayHello_pr_next_0_5211
sayHello_pr_str_0_5211:
  movq -152(%rbp), %rax
  addq $8, %rax
  movq %rax, -184(%rbp)
  movq -184(%rbp), %rax
