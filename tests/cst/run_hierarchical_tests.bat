...
if %ERRORLEVEL% neq 0 (
    echo [FAIL] If blocks test failed
    exit /b 1
)
...
if %ERRORLEVEL% neq 0 (
    echo [FAIL] Functions test failed
    exit /b 1
)
...
if %ERRORLEVEL% neq 0 (
    echo [FAIL] Expressions test failed
    exit /b 1
)
