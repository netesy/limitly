...
main_block_0:
  ...
  movq -48(%rbp), %rdx
  movq %rax, (%rdx)
  call std.collections.vector.__init__
  mov -184(%rbp), rax
  movq -184(%rbp), %rax
  movq -56(%rbp), %rdx
  movq %rax, (%rdx)
...
std.iterator.filter_entry:
  ...
  movq -72(%rbp), %rdx
  movq %rax, (%rdx)
  jmp std.iterator.filter_block_0
...
std.iterator.iterator_entry:
  ...
  movq -56(%rbp), %rdx
  movq %rax, (%rdx)
  jmp std.iterator.iterator_block_0
...
std.iterator.collect_entry:
  ...
  movq -56(%rbp), %rdx
  movq %rax, (%rdx)
  jmp std.iterator.collect_block_0
...
std.iterator.chunk_entry:
  ...
  movq -72(%rbp), %rdx
  movq %rax, (%rdx)
  jmp std.iterator.chunk_block_0
...
__user_main_block_0:
  ...
  movq -1160(%rbp), %rax
  testq %rax, %rax
  jne __user_main_assert_pass_1
  jmp __user_main_assert_fail_1
__user_main_assert_pass_1:
  movq $0, %rax
  movq -136(%rbp), %rdx
  movq %rax, (%rdx)
  movq -64(%rbp), %rax
...
__user_main_assert_pass_31:
  ...
  movq -2856(%rbp), %rax
  testq %rax, %rax
  jne __user_main_assert_pass_33
  jmp __user_main_assert_fail_33
...
__user_main_assert_fail_33:
  ...
  movq $50397203, %rax
  movq %rax, -2960(%rbp)
  jmp __user_main_assert_pass_33
...
std.iterator.cycle_entry:
  ...
  movq -56(%rbp), %rdx
  movq %rax, (%rdx)
  jmp std.iterator.cycle_block_0
