...
main_entry:
main_block_0:
  call std.collections.index.ArrayList
  movq [rel str_const_0], rcx
  call lm_box_string
  movq rax, [rbp + -64]
  movq $r0, rcx
  movq [rbp + -64], rdx
  call std.collections.vector.ArrayList.push
  ...
  call std.collections.vector.ArrayList.push
  movq $r0, rcx
  call std.collections.vector.ArrayList.len
  movq $r6, rax
  cmpq $17, rax
  setne al
  movzx eax, al
...
main_block_12:
  movq $r0, rcx
  call std.collections.vector.ArrayList.pop
...
main_block_18:
  ...
  movq $25, rdx
  movq [rbp + -104], r8
  call std.collections.vector.ArrayList.resize
  movq $r0, rcx
  movq $17, rdx
  call std.collections.vector.ArrayList.get
