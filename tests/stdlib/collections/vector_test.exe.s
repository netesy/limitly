...
main_block_0:
  movq $65, rcx
  call std.collections.index.Vector
  movq $r1, rcx
  movq $9, rdx
  call std.collections.vector.Vector.push
  movq $r1, rcx
  movq $17, rdx
  call std.collections.vector.Vector.append
  movq $r1, rcx
  movq $9, rdx
  movq $73, r8
  call std.collections.vector.Vector.insert
  movq $r1, rcx
  call std.collections.vector.Vector.len
  movq $r10, rax
  cmpq $25, rax
  setne al
  movzx eax, al
...
main_block_16:
  movq $r1, rcx
  movq $9, rdx
  call std.collections.vector.Vector.get
  movq $r16, rax
  cmpq $73, rax
  setne al
  movzx eax, al
...
main_block_23:
  movq $r1, rcx
  movq $9, rdx
  call std.collections.vector.Vector.remove
  movq $r22, rax
  cmpq $73, rax
  setne al
  movzx eax, al
...
main_block_30:
  ...
  movq $41, rdx
  movq $57, r8
  call std.collections.vector.Vector.resize
  movq $r1, rcx
  call std.collections.vector.Vector.len
  movq $r30, rax
  cmpq $41, rax
...
main_block_39:
  movq $r1, rcx
  call std.collections.vector.Vector.iterator
  movq $0, rax
  cmpq $9, rax
  setne al
  movzx eax, al
...
main_block_47:
  movq $r1, rcx
  call std.collections.vector.Vector.clear
  movq $r1, rcx
  call std.collections.vector.Vector.is_empty
  movq $r43, rax
  cmpq $18, rax
  setne al
  movzx eax, al
