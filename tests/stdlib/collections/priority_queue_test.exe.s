...
.align 8
str_const_0:
  .string "After push 10, length: %s"
.align 8
str_const_1:
  .string "After push 5, length: %s"
.align 8
str_const_2:
  .string "After push 20, length: %s"
.align 8
str_const_3:
  .string "After push 1, length: %s"
.align 8
str_const_4:
  .string "PriorityQueue length should be 4"
.align 8
str_const_5:
  .string "Peek should return 1 (min)"
.align 8
str_const_6:
  .string "Pop should return 1"
.align 8
str_const_7:
  .string "Pop should return 5"
.align 8
str_const_8:
  .string "Pop should return 10"
.align 8
str_const_9:
  .string "Pop should return 20"
.align 8
str_const_10:
  .string "Pop on empty PQ should return nil"
.align 8
str_const_11:
  .string "__lambda_0"
.align 8
str_const_12:
  .string "Max-heap peek should be 20"
.align 8
str_const_13:
  .string "PriorityQueue tests passed!"
.align 8
str_const_14:
  .string "ERR"
.align 8
...
main_block_0:
  ...
  movq [rbp + -64], rcx
  call std.collections.priority_queue.PriorityQueueWrapper.length
...
__lambda_0_block_0:
  ...
  movq [rbp + -80], rax
  testq rax, rax
  jne __lambda_0_block_2
  jmp __lambda_0_block_5
__lambda_0_block_2:
  jmp __lambda_0_block_2
  movq $9, rax
  negq rax
  movq rax, [rbp + -88]
  movq [rbp + -88], rax
...
__lambda_0_block_5:
  ...
  movq [rbp + -96], rax
  testq rax, rax
  jne __lambda_0_block_7
  jmp __lambda_0_block_9
__lambda_0_block_7:
  jmp __lambda_0_block_7
  movq $9, rax
  jmp __lambda_0_epilogue
__lambda_0_block_9:
  movq $1, rax
