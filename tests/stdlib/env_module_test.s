...
main_entry:
  ...
  jmp main_block_0
main_block_0:
  call std.env.platform.__init__
  mov -176(%rbp), rax
  movq -176(%rbp), %rax
  movq -48(%rbp), %rdx
  movq %rax, (%rdx)
  call std.env.variables.__init__
  mov -184(%rbp), rax
  movq -184(%rbp), %rax
  movq -56(%rbp), %rdx
  movq %rax, (%rdx)
...
std.env.index.args_entry:
  ...
  movq -128(%rbp), %rdx
  movq %rax, (%rdx)
  jmp std.env.index.args_block_0
...
std.env.variables.get_entry:
  ...
  movq -56(%rbp), %rdx
  movq %rax, (%rdx)
  jmp std.env.variables.get_block_0
...
test_env_helpers_block_0:
  ...
  movq -248(%rbp), %rax
  testq %rax, %rax
  jne test_env_helpers_pr_nil_0_9383
  jmp test_env_helpers_pr_str_0_9383
test_env_helpers_pr_nil_0_9383:
  ...
  syscall
  movq %rax, -264(%rbp)
  jmp test_env_helpers_pr_next_0_9383
test_env_helpers_pr_str_0_9383:
  movq -240(%rbp), %rax
  addq $8, %rax
  movq %rax, -272(%rbp)
  movq -272(%rbp), %rax
  ...
  movq %rax, -296(%rbp)
  jmp test_env_helpers_pr_next_0_9383
test_env_helpers_pr_next_0_9383:
  leaq nl(%rip), %rax
  addq $24, %rax
  movq %rax, -304(%rbp)
  movq $1, %rax
  ...
  movq -352(%rbp), %rax
  testq %rax, %rax
  jne test_env_helpers_assert_pass_3
  jmp test_env_helpers_assert_fail_3
test_env_helpers_assert_pass_3:
  movq $0, %rax
  movq -96(%rbp), %rdx
  movq %rax, (%rdx)
  ...
  movq -416(%rbp), %rax
  testq %rax, %rax
  jne test_env_helpers_assert_pass_5
  jmp test_env_helpers_assert_fail_5
test_env_helpers_assert_fail_3:
  movq -360(%rbp), %rax
  addq $8, %rax
  movq %rax, -432(%rbp)
  movq -432(%rbp), %rax
  ...
  movq $50397203, %rax
  movq %rax, -464(%rbp)
  jmp test_env_helpers_assert_pass_3
test_env_helpers_assert_pass_5:
  movq $0, %rax
  movq -144(%rbp), %rdx
  movq %rax, (%rdx)
  movq $1, %rax
...
test_env_helpers_assert_fail_5:
  movq -424(%rbp), %rax
  addq $8, %rax
  movq %rax, -480(%rbp)
  movq -480(%rbp), %rax
  ...
  movq $50397203, %rax
  movq %rax, -512(%rbp)
  jmp test_env_helpers_assert_pass_5
...
test_env_frame_block_0:
  ...
  movq -352(%rbp), %rax
  testq %rax, %rax
  jne test_env_frame_pr_nil_0_886
  jmp test_env_frame_pr_str_0_886
test_env_frame_pr_nil_0_886:
  leaq str_nil(%rip), %rax
  addq $24, %rax
  movq %rax, -360(%rbp)
  movq $1, %rax
  ...
  syscall
  movq %rax, -368(%rbp)
  jmp test_env_frame_pr_next_0_886
test_env_frame_pr_str_0_886:
  movq -344(%rbp), %rax
  addq $8, %rax
  movq %rax, -376(%rbp)
  movq -376(%rbp), %rax
...
test_env_frame_pr_next_0_886:
  ...
  movq -504(%rbp), %rax
  testq %rax, %rax
  jne test_env_frame_assert_pass_9
  jmp test_env_frame_assert_fail_9
test_env_frame_assert_pass_9:
  movq $0, %rax
  movq -128(%rbp), %rdx
  movq %rax, (%rdx)
  movq -88(%rbp), %rax
  ...
  movq -576(%rbp), %rax
  testq %rax, %rax
  jne test_env_frame_assert_pass_11
  jmp test_env_frame_assert_fail_11
test_env_frame_assert_fail_9:
  movq -512(%rbp), %rax
  addq $8, %rax
  movq %rax, -592(%rbp)
  movq -592(%rbp), %rax
  ...
  movq $50397203, %rax
  movq %rax, -624(%rbp)
  jmp test_env_frame_assert_pass_9
test_env_frame_assert_pass_11:
  movq $0, %rax
  movq -176(%rbp), %rdx
  movq %rax, (%rdx)
  ...
  movq -712(%rbp), %rax
  testq %rax, %rax
  jne test_env_frame_assert_pass_16
  jmp test_env_frame_assert_fail_16
test_env_frame_assert_fail_11:
  movq -584(%rbp), %rax
  addq $8, %rax
  movq %rax, -728(%rbp)
  movq -728(%rbp), %rax
  ...
  movq $50397203, %rax
  movq %rax, -760(%rbp)
  jmp test_env_frame_assert_pass_11
test_env_frame_assert_pass_16:
  movq $0, %rax
  movq -248(%rbp), %rdx
  movq %rax, (%rdx)
  movq $1, %rax
...
test_env_frame_assert_fail_16:
  ...
  movq $50397203, %rax
  movq %rax, -808(%rbp)
  jmp test_env_frame_assert_pass_16
...
std.env.platform.args_entry:
  ...
  movq -136(%rbp), %rdx
  movq %rax, (%rdx)
  jmp std.env.platform.args_block_0
...
std.env.platform.cwd_entry:
  ...
  movq -128(%rbp), %rdx
  movq %rax, (%rdx)
  jmp std.env.platform.cwd_block_0
...
std.env.variables.set_entry:
  ...
  movq -72(%rbp), %rdx
  movq %rax, (%rdx)
  jmp std.env.variables.set_block_0
...
__user_main_pr_next_0_2777:
  ...
  movq -360(%rbp), %rax
  testq %rax, %rax
  jne __user_main_assert_pass_20
  jmp __user_main_assert_fail_20
__user_main_assert_pass_20:
  movq $0, %rax
  movq -96(%rbp), %rdx
  movq %rax, (%rdx)
...
__user_main_assert_fail_20:
  ...
  movq $50397203, %rax
  movq %rax, -456(%rbp)
  jmp __user_main_assert_pass_20
