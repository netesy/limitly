...
print_shape_info_block_0:
  ...
  movq -184(%rbp), %rax
  testq %rax, %rax
  jne print_shape_info_pr_nil_0_9383
  jmp print_shape_info_pr_str_0_9383
print_shape_info_pr_nil_0_9383:
  ...
  syscall
  movq %rax, -200(%rbp)
  jmp print_shape_info_pr_next_0_9383
print_shape_info_pr_str_0_9383:
  movq -176(%rbp), %rax
  addq $8, %rax
  movq %rax, -208(%rbp)
  movq -208(%rbp), %rax
  ...
  movq %rax, -232(%rbp)
  jmp print_shape_info_pr_next_0_9383
print_shape_info_pr_next_0_9383:
  leaq nl(%rip), %rax
  addq $24, %rax
  movq %rax, -240(%rbp)
  movq $1, %rax
  ...
  movq -304(%rbp), %rax
  testq %rax, %rax
  jne print_shape_info_i2s_neg_1
  jmp print_shape_info_i2s_pos_1
print_shape_info_i2s_neg_1:
  movq $1, %rax
  movq -296(%rbp), %rdx
  movq %rax, (%rdx)
  movq -256(%rbp), %rax
  ...
  movq -288(%rbp), %rdx
  movq %rax, (%rdx)
  jmp print_shape_info_i2s_loop_1
print_shape_info_i2s_pos_1:
  movq $0, %rax
  movq -296(%rbp), %rdx
  movq %rax, (%rdx)
  movq -256(%rbp), %rax
...
print_shape_info_i2s_loop_1:
  ...
  movq -368(%rbp), %rax
  testq %rax, %rax
  jne print_shape_info_i2s_loop_1
  jmp print_shape_info_i2s_sign_1
print_shape_info_i2s_sign_1:
  movq -296(%rbp), %rax
  movq (%rax), %rax
  movq %rax, -376(%rbp)
  movq -376(%rbp), %rax
  ...
  movq -384(%rbp), %rax
  testq %rax, %rax
  jne print_shape_info_i2s_minus_1
  jmp print_shape_info_i2s_done_1
print_shape_info_i2s_minus_1:
  movq -280(%rbp), %rax
  movq (%rax), %rax
  movq %rax, -392(%rbp)
  movq -392(%rbp), %rax
...
__user_main_assert_pass_7:
  ...
  movq -752(%rbp), %rax
  testq %rax, %rax
  jne __user_main_assert_pass_9
  jmp __user_main_assert_fail_9
