...
int main() {
    ...
    try {
        ...
        std::cout << "\n[OK] All structured type parsing tests passed!" << std::endl;
        std::cout << "[OK] parseStructuralType() method is working correctly" << std::endl;
        std::cout << "[OK] StructuralTypeField support is implemented in TypeAnnotation" << std::endl;
        std::cout << "[OK] All requirements (5.1, 5.2, 5.3, 5.4) are satisfied" << std::endl;
        return 0;
