...
task_2_block_0:
  ...
  movq -448(%rbp), %rax
  testq %rax, %rax
  jne task_2_pr_nil_0_6649
  jmp task_2_pr_str_0_6649
task_2_pr_nil_0_6649:
  leaq str_nil(%rip), %rax
  addq $24, %rax
  movq %rax, -456(%rbp)
  movq $1, %rax
  ...
  syscall
  movq %rax, -464(%rbp)
  jmp task_2_pr_next_0_6649
task_2_pr_str_0_6649:
  movq -440(%rbp), %rax
  addq $8, %rax
  movq %rax, -472(%rbp)
  movq -472(%rbp), %rax
...
task_1_block_0:
  ...
  movq -352(%rbp), %rax
  testq %rax, %rax
  jne task_1_pr_nil_0_1421
  jmp task_1_pr_str_0_1421
task_1_pr_nil_0_1421:
  leaq str_nil(%rip), %rax
  addq $24, %rax
  movq %rax, -360(%rbp)
  movq $1, %rax
  ...
  syscall
  movq %rax, -368(%rbp)
  jmp task_1_pr_next_0_1421
task_1_pr_str_0_1421:
  movq -344(%rbp), %rax
  addq $8, %rax
  movq %rax, -376(%rbp)
  movq -376(%rbp), %rax
...
task_0_block_0:
  ...
  movq -256(%rbp), %rax
  testq %rax, %rax
  jne task_0_pr_nil_0_2362
  jmp task_0_pr_str_0_2362
task_0_pr_nil_0_2362:
  leaq str_nil(%rip), %rax
  addq $24, %rax
  movq %rax, -264(%rbp)
  movq $1, %rax
  ...
  syscall
  movq %rax, -272(%rbp)
  jmp task_0_pr_next_0_2362
task_0_pr_str_0_2362:
  movq -248(%rbp), %rax
  addq $8, %rax
  movq %rax, -280(%rbp)
  movq -280(%rbp), %rax
...
.globl _worker_94740284193088
_worker_94740284193088:
  .cfi_startproc
  pushq %rbp
  .cfi_def_cfa_offset 16
  .cfi_offset 6, -16
...
_worker_94740284193088_entry:
  ...
  movq -104(%rbp), %rdx
  movq %rax, (%rdx)
  jmp _worker_94740284193088_block_0
_worker_94740284193088_block_0:
  ...
  movq %rax, -256(%rbp)
  movq -256(%rbp), %rax
  jmp _worker_94740284193088_epilogue
_worker_94740284193088_epilogue:
  leaq -40(%rbp), %rsp
  popq %r15
  popq %r14
  popq %r13
  ...
  ret
  .cfi_endproc
.Lfunc_end__worker_94740284193088:

.globl _worker_94740284167280
_worker_94740284167280:
  .cfi_startproc
  pushq %rbp
  .cfi_def_cfa_offset 16
  .cfi_offset 6, -16
...
_worker_94740284167280_entry:
  ...
  movq -104(%rbp), %rdx
  movq %rax, (%rdx)
  jmp _worker_94740284167280_block_0
_worker_94740284167280_block_0:
  ...
  movq %rax, -256(%rbp)
  movq -256(%rbp), %rax
  jmp _worker_94740284167280_epilogue
_worker_94740284167280_epilogue:
  leaq -40(%rbp), %rsp
  popq %r15
  popq %r14
  popq %r13
  ...
  ret
  .cfi_endproc
.Lfunc_end__worker_94740284167280:

.globl _task_94740284209440
_task_94740284209440:
  .cfi_startproc
  pushq %rbp
  .cfi_def_cfa_offset 16
  .cfi_offset 6, -16
...
_task_94740284209440_entry:
  ...
  movq -104(%rbp), %rdx
  movq %rax, (%rdx)
  jmp _task_94740284209440_block_0
_task_94740284209440_block_0:
  ...
  movq -288(%rbp), %rax
  testq %rax, %rax
  jne _task_94740284209440_pr_nil_0_27
  jmp _task_94740284209440_pr_str_0_27
_task_94740284209440_pr_nil_0_27:
  leaq str_nil(%rip), %rax
  addq $24, %rax
  movq %rax, -296(%rbp)
  movq $1, %rax
  ...
  syscall
  movq %rax, -304(%rbp)
  jmp _task_94740284209440_pr_next_0_27
_task_94740284209440_pr_str_0_27:
  movq -280(%rbp), %rax
  addq $8, %rax
  movq %rax, -312(%rbp)
  movq -312(%rbp), %rax
  ...
  movq %rax, -336(%rbp)
  jmp _task_94740284209440_pr_next_0_27
_task_94740284209440_pr_next_0_27:
  leaq nl(%rip), %rax
  addq $24, %rax
  movq %rax, -344(%rbp)
  movq $1, %rax
  ...
  movq %rax, -384(%rbp)
  movq -384(%rbp), %rax
  jmp _task_94740284209440_epilogue
_task_94740284209440_epilogue:
  leaq -40(%rbp), %rsp
  popq %r15
  popq %r14
  popq %r13
  ...
  ret
  .cfi_endproc
.Lfunc_end__task_94740284209440:

.globl _worker_94740284180512
_worker_94740284180512:
  .cfi_startproc
  pushq %rbp
  .cfi_def_cfa_offset 16
  .cfi_offset 6, -16
...
_worker_94740284180512_entry:
  ...
  movq -104(%rbp), %rdx
  movq %rax, (%rdx)
  jmp _worker_94740284180512_block_0
_worker_94740284180512_block_0:
  ...
  movq %rax, -256(%rbp)
  movq -256(%rbp), %rax
  jmp _worker_94740284180512_epilogue
_worker_94740284180512_epilogue:
  leaq -40(%rbp), %rsp
  popq %r15
  popq %r14
  popq %r13
  ...
  ret
  .cfi_endproc
.Lfunc_end__worker_94740284180512:
