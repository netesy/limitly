...
public:
    void runTest(const std::string& filePath) {
        ...
        try {
            ...
            if (!file.is_open()) {
                std::cout << "[FAIL] FAIL: Could not open file\n";
                failedTests++;
                return;
            }
            ...
            if (parseResult.cst) {
                ...
                std::cout << "  - Round-trip: " << (roundTripSuccess ? "✓ PASS" : "[FAIL] FAIL") << "\n";
            ...
            if (testPassed) {
                ...
                std::cout << "\n[FAIL] FAIL: CST parsing failed\n";
                failedTests++;
            }
            
        } catch (const std::exception& e) {
            std::cout << "[FAIL] FAIL: Exception - " << e.what() << "\n";
            failedTests++;
        }
    }
