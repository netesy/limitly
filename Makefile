...
BACKEND_COMMON_SRCS := src/backend/backend.cpp src/backend/symbol_table.cpp src/backend/value.cpp src/backend/ast_printer.cpp src/backend/bytecode_printer.cpp src/backend/functions.cpp src/backend/closure_impl.cpp src/backend/classes.cpp src/backend/type_checker.cpp src/backend/function_types.cpp src/backend/src/fiber.cpp src/backend/src/scheduler.cpp 
...
MAIN_SRCS := src/main.cpp $(BACKEND_COMMON_SRCS) $(BACK_SRCS) $(COMMON_SRCS) $(ERROR_SRCS)  $(FRONT_SRCS) $(REGISTER_SRCS) $(LIR_CORE_SRCS) src/lir/function_registry.cpp
