...
//     // String builder compilation functions
//     gccjit::rvalue compile_sb_create();
//     void compile_sb_append(gccjit::rvalue sb, gccjit::rvalue value);
