    ...
    try {
        ...
        if (useCSTParser) {
            ...
            try {
                ...
                std::cerr << "[FAIL] FAILED: std::bad_alloc occurred in CST parser!" << std::endl;
                std::cerr << "This indicates the memory issue is not yet fixed." << std::endl;
                return 1;
            } catch (const std::exception& e) {
                std::cerr << "[FAIL] FAILED: Exception in CST parser: " << e.what() << std::endl;
                return 1;
            }
            ...
            try {
                ...
                std::cerr << "[FAIL] FAILED: Exception in fallback mode: " << e.what() << std::endl;
            }
            ...
            try {
                ...
                std::cerr << "[FAIL] FAILED: Exception in legacy parser: " << e.what() << std::endl;
                return 1;
            }
        ...
        if (ast) {
            ...
            std::cout << "[FAIL] No AST available - parsing failed\n";
        }
        ...
        if (ast) {
            ...
            if (typeErrors.empty()) {
                ...
                std::cout << "[FAIL] Found " << typeErrors.size() << " type error(s):\n";
            ...
            if (typeCheckFile.is_open()) {
                ...
                if (typeErrors.empty()) {
                    ...
                    typeCheckFile << "[FAIL] Found " << typeErrors.size() << " type error(s):\n\n";
            ...
            std::cout << "[FAIL] No type checking performed - AST not available\n";
        }
        ...
        if (ast) {
            ...
            std::cout << "[FAIL] No bytecode generated - AST not available\n";
        }
